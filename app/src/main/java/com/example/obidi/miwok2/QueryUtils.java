...
public class QueryUtils {
    ...
    public static ArrayList<Word> getWords(String category) {
        switch (category.toLowerCase()) {
            case "number": return getNumbers();
            case "phrase": return getPhrases();
            case "family": return getFamily();
            case "color": return getColors();
            default: return null;
        }
    }

    private static ArrayList<Word> getNumbers() {
    ...
    private static ArrayList<Word> getPhrases() {
        final ArrayList<Word> words = new ArrayList<Word>();
    ...
    private static ArrayList<Word> getFamily() {
        final ArrayList<Word> words = new ArrayList<Word>();
    ...
    private static ArrayList<Word> getColors() {
        final ArrayList<Word> words = new ArrayList<Word>();
